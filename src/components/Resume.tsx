  ...
  return (
    <section id="resume" className="py-20 px-4 bg-white">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="bg-gradient-to-br from-gray-50 to-white rounded-2xl shadow-xl p-8 mb-8">
          {/* Resume Preview */}
          <div className="bg-white border-2 border-gray-200 rounded-lg p-6 mb-8 shadow-inner">
            <div className="aspect-[8.5/11] bg-gradient-to-br from-blue-50 to-purple-50 rounded-lg flex items-center justify-center">
              <div className="text-center">
                <div className="w-16 h-16 bg-gradient-to-r from-blue-600 to-purple-600 rounded-full flex items-center justify-center mx-auto mb-4">
                  <Eye className="h-8 w-8 text-white" />
                </div>
                <h3 className="text-xl font-bold text-gray-800 mb-2">Resume Preview</h3>
                <p className="text-gray-600">Click below to view or download the full resume</p>
              </div>
            </div>
          </div>
